        ...
        <main>  
            <div id="janela_formulario">
                <form action="alteracao_produto.php" method="post">
                    ...
                    <input type="text" value="<?php echo $info_produto["estoque"]?>" name="estoque">
                    
                    <label for="valorproduto">Valor do produto </label>
                    <input type="text" value="<?php echo $info_produto["valorproduto"]?>" name="valorproduto">

                    <label for="statusproduto">Status da conta do cliente</label>
